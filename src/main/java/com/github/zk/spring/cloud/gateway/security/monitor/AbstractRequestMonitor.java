...
public abstract class AbstractRequestMonitor implements RequestMonitor {
    ...
    private final RequestMonitorMapper requestMonitorMapper;

    public AbstractRequestMonitor(RequestMonitorMapper requestMonitorMapper) {
        this.requestMonitorMapper = requestMonitorMapper;
    }
